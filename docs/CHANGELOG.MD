...
- [merlin-agent/Issue 6](https://github.com/yok4i/merlin-agent/issues/6) - Message padding is now a random length instead of a fixed length
...
* [issue 116](https://github.com/yok4i/merlin/issues/116) - Fixed missing statement to enable verbose & debug output for the server component
* [issue 119](https://github.com/yok4i/merlin/issues/116) - Add specific agent ID instead of broadcast "F" agent ID
...
- [Issue 107](https://github.com/yok4i/merlin/issues/107) - RunModule() tasking uses `run` instead of removed `cmd`
...
- [Pull 97](https://github.com/yok4i/merlin/pull/97) - Incorrectly validated the module and agent platforms when the agent was set to "all"
...
- [Issue 88](https://github.com/yok4i/merlin/issues/88) - Set option will now take all arguments after a space
- Added module type to LinEnum, MimiPenguin, and SwapDigger
- [Issue 71](https://github.com/yok4i/merlin/issues/71) - Run a module against all agents
...
- [Issue 77](https://github.com/yok4i/merlin/issues/77) - Set server and agent log files with `0640` permissions
...
- [Pull 72](https://github.com/yok4i/merlin/pull/72) - Added a Linux module that will hide the Merlin process from tools that walk the /proc filesystem by @ForensicITGuy
- [Pull 73](https://github.com/yok4i/merlin/pull/74) - Added 5 Linux evasion and persistence modules by @ForensicITGuy
- [Pull 76](https://github.com/yok4i/merlin/pull/76) - Prompt user to confirm exit or quit by [Daniel Roberson](https://github.com/droberson)

### Fixed

- [Pull 74](https://github.com/yok4i/merlin/pull/74) - Fixed issued that would crash the agent if the skew was set to 0 by @alexbires
- [Issue 54](https://github.com/yok4i/merlin/issues/54) - Prompt to exit server when user types "quit" or "exit"
...
-[Issue 69](https://github.com/yok4i/merlin/issues/69) - Error with modules missing type definition
-[Issue 70](https://github.com/yok4i/merlin/issues/70) - Error parsing a shellcode file containing raw bytes

## 0.7.0 - 2019-04-11

### Added
- [Pull 48](https://github.com/yok4i/merlin/pull/48) - Added `ls` command to agent & agent menu. Uses go code native to Merlin instead of executing `ls` or `dir` binary
- New `NativeCmd` message struct for commands native to Merlin
- [Pull 49](https://github.com/yok4i/merlin/pull/49) - Added tests for agent package and new `/test` directory for test HTTP server
- [Pull 50](https://github.com/yok4i/merlin/pull/50) - Adds a killdate option to agents
  - Added `set killdate` to Merlin Server agent menu and information table so that it can be changed from the server.
- [Pull 51](https://github.com/yok4i/merlin/pull/51) - Adds a Go native `minidump` module for Windows agents to create and receive a minidump file of a specified process (requires elevation)
...
- [Pull 58](https://github.com/yok4i/merlin/pull/58) - Added feature to generate in-memory TLS certificates one is not provided
...
- [Pull 60](https://github.com/yok4i/merlin/pull/60) - Added `pwd` and `cd` command to agent & agent menu. 
...
- [Pull 64](https://github.com/yok4i/merlin/pull/64) - Added in Dockerfile by Alex Flores (@audibleblink)

### Fixed
- [Pull 57](https://github.com/yok4i/merlin/pull/57) - Resolved broken JSON does not increment failedCheckin counter on Merlin agent
...
### Removed
- Removed publicly distributed certificates from repository see [Pull 58](https://github.com/yok4i/merlin/pull/58).
...
### Added
- [Pull 45](https://github.com/yok4i/merlin/pull/45) - Added a module for Python-based SOCKS proxying (@klusitc)
...
- [Pull 43](https://github.com/yok4i/merlin/pull/43) - Gives users the ability to dynamically
assign the callback URL variable at compile time by setting the URL= var in the make command by Alex Flores (@audibleblink)

### Fixed
- [Pull 44](https://github.com/yok4i/merlin/pull/44) Fixes case-sensitive autocompletion of `agent`
  on the module menu (@audibleblink)

## 0.6.5 - 2019-01-10

### Fixed
- [Issue 41](https://github.com/yok4i/merlin/issues/41) Error when downloading a file using a path containing a space
...
### Changed
- [Issue 26](https://github.com/yok4i/merlin/issues/26) Updated Makefile to remove .dmg file extension for Darwin
- [Issue 23](https://github.com/yok4i/merlin/issues/23) Error when using upload command without specific arguments
- [Issue 28](https://github.com/yok4i/merlin/issues/28) Updated MimiPenguin module to use new path to download mimipenguin.sh
...
### Fixed
- [Issue 23](https://github.com/yok4i/merlin/issues/23) Error writing an agent log entry when agent was set to 'all'
